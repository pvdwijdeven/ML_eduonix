# 1. Create a 3 x 4 matrix, A, and fill it row-wise with the numbers 1-12. What is a_24?
A <- matrix(1:12, nrow = 3, ncol = 4, byrow = TRUE)
# a_24 = 8

# 2. Create two 1 x 2 vectors, v1 and v2, with numeric entries of your choice. 
#    Plot v1 and v2 on the same coordinate plane.
v1 <- c(1,4)
v2 <- c(5,8)
...
# 3. Now add 3 to the second entry in v1 and re-plot. 
#    Describe the position of the new vector in 2-space relative to v1.
v1.new <- c(1,7)
